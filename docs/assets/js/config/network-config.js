export const NETWORK_CONFIG = Object.freeze({
  ...
  interaction: Object.freeze({
    radius: 140,
    influenceEnterResponse: 3.5,
    influenceExitResponse: 1.2,
    cameraResponse: 2.8,
    cameraReleaseResponse: 1.3,
    nodeSwitchBias: 20,
    maximumZoom: 1.48,
    outbreakThreshold: 0.56,
    outbreakCooldown: 1400,
  ...
  infection: Object.freeze({
    ...
    outbreakRatioMinimum: 0.25,
    outbreakRatioMaximum: 0.45,
    outbreakStepDelayMinimum: 45,
    outbreakStepDelayMaximum: 85,
    outbreakTransmissionMinimum: 160,
    outbreakTransmissionMaximum: 280,
    outbreakNodeHoldMinimum: 900,
    outbreakNodeHoldMaximum: 1800,
    outbreakEdgeHoldMinimum: 600,
    outbreakEdgeHoldMaximum: 1100,
